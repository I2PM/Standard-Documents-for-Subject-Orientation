...
\begin{list}{-}
	...
	\item Subject-Phase Matrix for expressing processes focusing on phases
...
\begin{figure}[hbtp]
	\includegraphics[scale=0.7]{Figures/Chapter5/Subject-Phase/SCD-Order.png}
...
\begin{figure}[hbtp]
	\includegraphics[scale=0.35]{Figures/Chapter5/Subject-Phase/SBD-Customer-AO.png}
...
\begin{figure}[hbtp]
	\includegraphics[scale=0.7]{Figures/Chapter5/Subject-Phase/SBD-ForwardingAGentAO.png}
...
\begin{figure}[hbtp]
	\includegraphics[scale=0.4]{Figures/Chapter5/Subject-Phase/CarrierAO.png}
...
\begin{figure}[hbtp]
	\includegraphics[scale=0.4, angle=90]{Figures/Chapter5/Subject-Phase/SCD-ExecuteTransport.png}
...
\begin{figure}[hbtp]
	\includegraphics[scale=0.7]{Figures/Chapter5/Subject-Phase/SBD-Carrier-ET.png}
