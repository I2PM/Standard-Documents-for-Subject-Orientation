...
\begin{table}[htbp]
    ...
    \begin{tabular}[t]{@{}l p{0.3\linewidth} p{0.3\linewidth} @{}}
        ...
        Subject Restart
        &
        Implicit after \textit{proper termination} when an additional message arrives.
        &
        ...
        \bottomrule
    \end{tabular}
    \caption{Conceptual Differences (1)}
...
\begin{table}[htbp]
    ...
    \begin{tabular}[t]{@{}l p{0.3\linewidth} p{0.3\linewidth} @{}}
        ...
        \bottomrule
    \end{tabular}
    \caption{Conceptual Differences (2)}
...
\begin{table}[htbp]
    ...
    \begin{tabular}[t]{@{}l p{0.3\linewidth} p{0.3\linewidth} @{}}
        ...
        \bottomrule
    \end{tabular}
    \caption{Conceptual Differences (3)}
