...
\begin{table}[htbp]
    \footnotesize
	\centering
    \begin{tabular}[t]{@{}l p{0.35\linewidth} p{0.35\linewidth} @{}}
        \toprule
...
Table~\ref{tbl:asm:concepts_3} lists advanced concepts, that are not part of the OWL description.
...
% TODO: Subject Data & Scope.

% TODO: Observer table~\ref{tbl:asm:concepts_4}
...
\begin{table}[htbp]
    ...
    \begin{tabular}[t]{@{}l p{0.35\linewidth} p{0.35\linewidth} @{}}
        ...
        \bottomrule
    \end{tabular}
    \caption{Advanced Conceptual Differences}
...
\begin{table}[htbp]
    ...
    \begin{tabular}[t]{@{}l p{0.35\linewidth} p{0.35\linewidth} @{}}
        ...
        Observer
        &
        Indiectly supported, requires manual modelling of State Priorities:
        The guarded state is modelled in one \OWLClass{ChoiceSegmentPath}, a second \OWLClass{ChoiceSegmentPath} starts with a \OWLClass{ReceiveState} that has a high State Priority.
        ...
        After the exception handling the subject can terminate, the paused state can continue or the paused state can be aborted with the Cancel Function.
        &
