...
\subsubsection{Data Mapping: Relationship of Behavior to Data}

\begin{figure}[ph]
	\centering
	\includegraphics[width=1.0\linewidth]{20181026-Ontologie-Bilder/Grafiken-Ontologie/SUbjectExecution/20190106-DataMapping}
	\caption[Relationship of Behavior to Data]{Relationship of Behavior to Data}
	\label{fig:20190106-datamapping}
\end{figure}
