...
& Range: &PASSProcessModelElement & & \\
\hline
hasSender &Domain: &MessageExchange && \ \ 226\\
& Range: &Subject & &\\
\hline
hasSourceState & Domain: &Transition& &\ \ 227\\
& Range: &State&  &\\
\hline
hasStartSubject & Domain: &PASSProcessModel& &\ \ 228\\
& Range: &StartSubject& & \\
\hline
hasTargetState & Domain &Transition& &\ \ 229\\
& Range &State& & \\
\hline
hasTransitionCondition &Domain &Transition & &\ \ 230\\
& Range &TransitionCondition & & \\
\hline
isBaseBehaviorOf &Domain: &SubjectBaseBehavior & A specialized version of the "belongsTo" ObjectProperty to denote that a -SubjectBehavior belongs to a Subject as its BaseBehavior&\ \ 231\\
& Range: &&  &\\
\hline
isEndStateOf & Domain: &State and not SendState & &\ \ 232\\
& Range: &SubjectBehavior or ChoiceSegmentPath &  &\\
\hline
isInitialStateOf & Domain: &State& &\ \ 233\\
& Range: &SubjectBehavior or ChoiceSegmentPath &  &\\
\hline
isReferencedBy & Domain: & & &\ \ 234\\
& Range: &&  &\\
\hline
references & Domain: & & &\ \ 235\\
& Range: & &  &\\
\hline
referencesMacroBehavior &Domain: &MacroState & &\ \ 236\\
& Range: &MacroBehavior & & \\
\hline
refersTo & Domain: &CommunicationTransition&Communication transitions (send and receive) should refer to a message exchange that is defined on the interaction layer of a model. & \ \ 237\\
& Range: &MessageExchange& & \\
\hline
requiresActiveReception-OfMessage &Domain: &ReceiveTransitionCondition & &\ \ 238\\
& Range: &MessageSpecification &  &\\
\hline
requiresPerformed-MessageExchange & Domain: &MessageExchangeCondition& &\ \ 239\\
& Range: &MessageExchange &  &\\
\hline
SimplePASSObject-Propertie & Domain: & &Every element/sub-class of SimplePASSObjectProperties is also a Child of PASSModelObjectPropertiy. This is simply a surrogate class to group all simple elements together &\ \ 240\\
& Range: & &  &\\
\hline
\end{longtable}
\end {landscape}
